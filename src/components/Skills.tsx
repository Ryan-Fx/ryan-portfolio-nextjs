  ...
  return (
    <section className="scroll-mt-24 md:my-24" id="skills">
      ...
      {filteredSkills.map((skill) => (
        <div className="inline-flex pt-6 mr-4">
          <p className="bg-fuchsia-500 shadow-md shadow-slate-500/50 text-white py-2 px-6 rounded-full hover:scale-110 hover:bg-pink-400 font-semibold transition animate-bounce">
            {skill.name}
          </p>
        </div>
      ))}
